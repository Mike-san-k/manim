...
_FRAMEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='animation_index', full_name='frameserver.FrameRequest.animation_index', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='animation_offset', full_name='frameserver.FrameRequest.animation_offset', index=1,
